...
class WebSys {
	static get WEBSYS_VERSION() { return '0.4.0'; }
	static get WSCLIENT_VERSION() { return '0.3.4'; }
	...
	async runApp(name) {
		return await this.runAppFetch('/app/' + name + '/manifest');
	}

	async runAppFetch(manifestURL) {
		try {
